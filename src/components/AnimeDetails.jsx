    ...
    <div className="p-4">
      ...
      <div className="anime-details flex flex-col md:flex-row items-start gap-6">
        ...
        <div className="anime-content flex-1">
          ...
          <p className="text-gray-500 italic">{anime.title_japanese || "No Japanese Title"}</p>
          ...
          {/* Sinopsis */}
          <p className="mt-4"><strong>Synopsis:</strong> {anime.synopsis || "No synopsis available."}</p>
        </div>
      </div>
